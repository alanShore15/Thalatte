...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { connection_id: @connection.connection_id, connection_type: @connection.connection_type, user_id: @connection.user_id }
    end
  ...
  test "should update connection" do
    patch :update, id: @connection, connection: { connection_id: @connection.connection_id, connection_type: @connection.connection_type, user_id: @connection.user_id }
    assert_redirected_to connection_path(assigns(:connection))
  end
