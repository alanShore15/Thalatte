...
class InstitutesControllerTest < ActionController::TestCase
  ...
  test "should create institute" do
    assert_difference('Institute.count') do
      post :create, institute: { city: @institute.city, country: @institute.country, institute_name: @institute.institute_name }
    end
  ...
  test "should update institute" do
    patch :update, id: @institute, institute: { city: @institute.city, country: @institute.country, institute_name: @institute.institute_name }
    assert_redirected_to institute_path(assigns(:institute))
  end
